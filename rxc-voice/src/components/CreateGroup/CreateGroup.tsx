  ...
  return (
    <form className="create-event" onSubmit={createEvent}>
      <div className="create-event_header">
        ...
        <p>Fill out the information below to create your group.</p>
      </div>
      <h2>General Information</h2>
      <p>Fill out the general information for this group.</p>
      <div className="event-section">
        <label>Group Name</label>
        <p>Add a name to this group.</p>
      ...
      <div className="event-section">
        ...
        <p>Add a description to this new group.</p>
        <div className="event-section_form">
          <textarea
